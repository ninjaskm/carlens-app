...
<img src="https://raw.githubusercontent.com/CarLensByMatheus/carlens-app/main/logo.png" width="120" alt="CarLens Logo"/>
...
* ⚖️ **Comparação técnica** — compare dois veículos lado a lado com destaque visual para vantagens e desvantagens (potência, torque, 0-100, vel. máx., câmbio, tração e mais)
* ➕ **Cadastro de veículos** — formulário completo com dados básicos, motor e especificações técnicas, enviado para aprovação administrativa
* 🔗 **Redirecionamento** — links diretos para OLX e WebMotors para compra
...
|Login|Cadastro|Home|
|-|-|-|
|!\[Login](screenshots/login.jpg)|!\[Cadastro](screenshots/cadastro.jpg)|!\[Home](screenshots/home.jpg)|

|Pesquisa|Comparação|Cadastrar Carro|
|-|-|-|
|!\[Pesquisa](screenshots/pesquisa.jpg)|!\[Comparação](screenshots/comparacao.jpg)|!\[Cadastrar](screenshots/cadastrar.jpg)|
